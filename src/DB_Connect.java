...
public class DB_Connect {
    ...
    public void writeData() {
        try {
            ...
            // Q //
            /* 1 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (1, 'Solve (11-5)x(63-59+6)/12', '5', '7', '8', '10', 'Maths')");
            /* 2 */
            ...
            /* 15 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (15, 'Which of the following are geometric series?', " +
                    "'4,8,16...', '3,4,10...', '2,4,74...', '1,2,5...', 'Maths')");
            /* 16 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (16, 'Find a common ratio in the following geometric series: 5,15,45...', " +
            ...
            /* 19 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (19, 'What is the 31st term in the following arithmetic series: 45,42.5,40...?', " +
                    "'-30', '-29', '-31', '-03', 'Maths')");
            /* 20 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (20, 'If x=5, find: 5x + 7'," +
                    " '32', '33', '31', '30', 'Maths')");
            /* 21 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (21, 'State the binary representation of the denary number 91.'," +
                    " '1011011', '111011', '111011', '1111011', 'Computer Science')");
            /* 22 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (22, 'State the denary equivalent of this pattern 10110110.'," +
                    " '182', '183', '181', '180', 'Computer Science')");
            /* 23 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (23, 'State the hexadecimal equivalent of the denary number 182.'," +
                    " 'B6', 'B7', 'B5', 'B8', 'Computer Science')");
            /* 24 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (24, 'What is meant by an algorithm?'," +
            ...
            /* 25 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (25, 'Machine code is the first generation of programming language. What is the second generation of programming language?'," +
                    " 'Assembly code', 'Function code', 'Class code', 'Interface code', 'Computer Science')");
            /* 26 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (26, 'What does the term peripheral mean?'," +
                    " 'A hardware device', 'A software device', 'A terminal device', 'A console device', 'Computer Science')");
            /* 27 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (27, 'URL : https://www.westminster.ac.uk/ - State the top-level domain part in the URL.'," +
                    " 'uk.', '.co', 'www.', 'https:', 'Computer Science')");
            /* 28 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (28, 'What is the role of a DNS server?'," +
            ...
            /* 29 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (29, 'What problem has resulted from performing the calculation using 8-bit two’s complement binary?'," +
            ...
            /* 32 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (32, 'Which of these is a reason fire breathers can’t breathe properly after years of doing it?'," +
                    " 'Less elasticity', 'More elasticity', 'Less electricity', 'More electricity', 'Science')");
            /* 33 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (33, 'Which is a way in which antibiotics can prevent the growth of bacteria?'," +
                    " 'Prevent cell wall formation', 'Provide cell wall formation', 'Prevent gene wall formation', 'Provide gene wall formation', 'Science')");       
            /* 34 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (34, 'Ammonia gas readily condenses to form a liquid when cooled. Name the strongest attractive force between two ammonia molecules. '," +
                    " 'Hydrogen bonds', 'Oxygen bonds', 'Nitrogen bonds', 'Carbon bonds', 'Science')");            
            /* 35 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (35, 'Name an element that has a half-filled set of p-orbital'," +
                    " 'Nitrogen', 'Oxygen', 'Hydrogen', 'Carbon', 'Science')");
            /* 36 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (36, 'Which of the following carry a negative charge?'," +
                    " 'Electron', 'Proton', 'Neutrons', 'Nucleus', 'Science')");
            /* 37 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (37, 'Name the process that resulted in the development of woodland from farmland.'," +
                    " 'Succession', 'Disturbance', 'Photosynthesis', 'The Carbon Cycle', 'Science')");           
            /* 38 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (38, 'The genetic code uses four different DNA bases. What is the maximum number of different DNA triplets that can be made using these four bases?'," +
                    " '64', '32', '128', '16', 'Science')");           
            /* 39 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (39, 'Transcription of a gene produces pre-mRNA. Name the process that removes base sequences from pre-mRNA to form mRNA.'," +
                    " 'Splicing', 'Splitting', 'Spinning', 'Storming', 'Science')"); 
            /* 40 */
           st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (40, 'Which one of the following is a fundamental particle that would not be deflected by an electric field?'," +
                    " 'Neutron', 'Atom', 'Proton', 'Neutron', 'Nucleus')");          
            /* 41 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (41, 'Which of the following element that has a half-filled set of p-orbitals.'," +
                    " 'Nitrogen', 'Oxygen', 'Hidyrogen', 'Carbon', 'Science')");          
            /* 42 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (42, 'Which of the following carry a negative charge?'," +
                    " 'electron and beta-particle', 'electron and alpha-particle', 'proton and meta-particle', 'proton and alpha-particle', 'Science')");           
            /* 43 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (43, 'Name the enzyme that can extend a cell’s life, by subverting the “normal” ageing process shorten with each division of a cell?'," +
                    " 'Telomerase', 'Telomere', 'Nucleotide', 'Angiogenesis', 'Science')");           
            /* 44 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (44, 'What are different masses of an atom in the same element called?'," +
                    " 'Isotopes', 'Protium', 'Deuterium', 'Tritium', 'Science')");
            /* 45 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (45, 'On a molecular level, why is water such a good solvent?'," +
                    " 'it is polar', 'it is air', 'it is ice', 'it is sea', 'Science')");           
            /* 46 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (46, '6.02x10^23 represents which number?'," +
                    " 'Avogrado’s number', 'PI number', 'Graham’s number', 'Golden number', 'Science')");
            /* 47 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (47, 'Which of the following statements is true about noble gases?'," +
                    " 'They are very non-reactive', 'They are very active', 'They are non-reactive', 'They are not very non-reactive', 'Science')");           
            /* 48 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (48, '8. Glycolysis is the process of breaking glucose down into what?'," +
                    " 'Pyruvate', 'Lactate', 'Oxaloacetate', 'Acetyl CoA', 'Science')");           
            /* 49 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (49, 'Which organelle is responsible for carrying proteins to amino acid during DNA synthesis?'," +
                    " 'Ribosomes', 'Nucteotide', 'Polypeptide', 'Terminus', 'Science')");
            /* 50 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (50, 'The Fibonacci Sequence is an example of which kind of formula?'," +
                    " 'Recursion', 'Inverse', 'Hyperbolic', 'Calculus', 'Science')");
            /* 51 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (51, 'Which sentence describes one impact of climate change upon global precipitation rates?',"
            ...
            /* 52 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (52, 'Which terms apply to land-based transfers of water?', " + 
            ...
            /* 53 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (53, 'To what does the carbon budget refer?',"
            ...
            /* 54 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (54, 'Why are some rivers in hot deserts ephemeral?', "
            ...
            /* 55 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (55, 'Wind has a direct impact on the development of which erosional landforms?', "
            ...
            /* 56 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (56, 'Which of the following is a cause of desertification?',"
            ...
            /* 57 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (57, 'Which of the following describes the sediment budget?',"
            ...
            /* 58 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (58, 'Where do erosional coastal landscapes tend to develop?',"
            ...
            /* 59 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (59, 'Where do sand dunes tend to form?',"
            ...
            /* 60 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (60, 'Which of these phrases describes what is meant by the globalisation of the world economy?', "
            ...
            /* 61 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (61, 'Which of these phrases describes the global commons?', "
            ...
            /* 62 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (62, 'Which of these pairs of statements can both be applied to all transnational corporations (TNCs)?',"
            ...
            /* 63 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (63, 'Which statement best explains why most of the population of the people’s Republic of China live in the eastern third of the nation?', "
            ...
            /* 64 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (64, 'In Japan, a major economic problem has been the lack of', "
                    + "'natural resources', 'investment capital', 'skilled labor', 'experienced management', 'Geography')");
            /* 65 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (65, 'Both Japan and Indonesia are made up of a chain of islands called', "
                    + "'an archipelago', 'a peninsula', 'a delta', 'an atoll', 'Geography')");
            /* 66 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (66, 'Characteristics of constructive waves include:', "
                    + "'Long Wavelength', 'Strong Wash', 'Gentle waves', 'Long wave period', 'Geography')");
            /* 67 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (67, 'Processes operating at the coast include', "
            ...
            /* 68 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (68, 'Wave trough is', "
                    + "'The lowest point of a wave', 'Number of waves per minute', 'Distance between wave crests', 'Time between wave crests', 'Geography')");
            /* 69 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (69, 'The correct sequence leading to the formation of a stump is', "
                    + "'Geo, cave, arch, stack', 'Arch, blowhole, geo, stack', 'Blowhole, cave, geo, stack', 'Cave, arch, geo, stack', 'Geography')"); 
            /* 70 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (70, 'Many spits have curved ends because',"
            ...
            /* 71 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (71, 'Which document is an example of a primary source?',"
            ...
            /* 72 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (72, 'Which historical events are in the correct chronological order?',"
            ...
            /* 73 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (73, 'Which condition is most necessary to the process of industrialization in a society?',"
            ...
            /* 74 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (74, 'According to Karl Marx, history is the record of the',"
            ...
            /* 75 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (75, 'A main idea of Karl Marx and Friedrich Engles’ Communist Manifesto is that the proletariat:',"
            ...
            /* 76 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (76, 'Which argument did President Abraham Lincoln use against the secession of the Southern States?',"
            ...
            /* 77 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (77, 'The abolitionist movement, the women’s suffrage movement, and the 1960’s civil rights movement are all examples of reform efforts that:',"
            ...
            /* 78 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (78, 'Which statement best explains President Abraham Lincoln’s justification for the Civil War?',"
            ...
            /* 79 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (79, 'A major result of the Civil War was that the',"
            ...
            /* 80 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (80, 'Sectional differences developed in the United States largely because',"
            ...
            /* 81 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (81, 'A major cause of the growth of state and Federal highway systems after World War II was the',"
            ...
            /* 82 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (82, 'During World War II, women and minorities made economic gains mainly because:',"
            ...
            /* 83 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (83, 'A major cause of the internment of Japanese Americans during World War II was',"
            + " 'racial prejudice', 'immigration quotas', 'national segregation policies', 'economic depression', 'History')");
            /* 84 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (84, 'A violation of civil rights that occurred in the United States during World War II was the:',"
            ...
            /* 85 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (85, 'Which action best illustrates the policy of isolationism followed by the United States before it entered World War II?',"
            ...
            /* 86 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (86, 'In the 1930’s, the United States attempted to avoid a repetition of the events leading up to United States involvement in World War I by:',"
            ...
            /* 87 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (87, 'After World War II, the United States was better able than its allies to adjust its economy from wartime to peacetime because the United States',"
            ...
            /* 88 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (88, 'Which congressional action not only raised money for World War II but also contributed to the national debt?',"
            ...
            /* 89 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (89, 'What was a key challenge faced by the United States during World War II?',"
            ...
            /* 90 */
            st.executeUpdate("INSERT INTO theDreamersTable " + "VALUES (90, 'In the period following World War II, the United States established a long term military presence in West Germany in an effort to:',"
